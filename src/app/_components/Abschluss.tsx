    ...
    <div className="mx-auto w-full max-w-2xl">
      ...
      <Card className="overflow-hidden">
        <div className="bg-gradient-to-br from-green to-green-dark px-8 py-10 text-center text-white sm:px-10">
          ...
          <h2 className="mt-3 text-3xl font-bold sm:text-4xl">Check abgeschlossen, {name}.</h2>
        ...
        <div className="space-y-5 px-8 py-8 sm:px-10">
          ...
          <div className="rounded-2xl bg-green-soft p-5">
            ...
            {aufgaben.starkeTeile.length > 0 && (
              <p className="mt-3 text-sm leading-relaxed text-ink">
                <span className="font-semibold text-green-dark">Besonders stark im Check: </span>
                {aufgaben.starkeTeile.join(", ")}.
              </p>
            )}
            {aufgaben.bonusGemacht && (
              <p className="mt-3 text-sm leading-relaxed text-ink">
                <span className="font-semibold text-green-dark">🔥 Bonus-Runde gemacht: </span>
                {aufgaben.bonusSelbststaendig}/{aufgaben.bonusTotal} der kniffligen Aufgaben im Griff.
              </p>
            )}
            {aufgaben.tipps > 0 && (
          ...
          <div className="rounded-2xl border border-line p-5">
            <p className="text-sm font-semibold text-ink">🚀 So geht&apos;s jetzt weiter</p>
            <p className="mt-2 text-sm leading-relaxed text-ink-soft">
              Gleich startet der Schnuppertag richtig – Nicolas führt dich durch den
              Tag. Nimm dein stärkstes Feld als Rückenwind, bleib neugierig und trau
              dich zu fragen. Am Ende weisst du mehr als jeder Test verraten kann.
            </p>
          </div>
